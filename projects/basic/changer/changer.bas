...
stars_gfx_loc=sprite[stars].gfxbase                               ' R_gfxbase is the property of the sprite that says where the graphics live
...
jsfLoadClut(strptr(STARS_clut),15,16)                                          ' This pops the colours from the stars graphic into the last 16 of the CLUT
