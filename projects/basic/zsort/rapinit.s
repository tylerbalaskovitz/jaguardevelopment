...
;			value			possible values							description															label to access
	...
	dc.w	300,0			; 										; Put sprite this many pixels from left side of screen.				;   R_sprite_x
	dc.w	20,0			; 										; Put sprite this many pixels down from top of screen.				;   R_sprite_y
	...
	dc.l	SPRITE_S		;										; Place in memory where the sprite lives: label from RAPAPP.S		;   R_sprite_gfxbase
	...
	dc.l	is_trans		; is_trans			is_opaque			; Trans for see-through background, opaque for solid background		;   R_sprite_trans
	...
	dc.l	32				;										; 32 is 1:1. 0-31 are scaled down, 33-228 are scaled up.			;   R_sprite_scale_x
	dc.l	32				; 										; 32 is 1:1. 0-31 are scaled down, 33-228 are scaled up.			;   R_sprite_scale_y
...
; 8 Sprites to sort
;			value			possible values							description															label to access
	dc.l	8				; 										; How many sprites like this one do you want in the sprite list?
	dc.l	is_active		; is_active			is_inactive			; Will the sprite be active on screen or inactive?					;   R_sprite_active
	dc.w	32,0			; 										; Put sprite this many pixels from left side of screen.				;   R_sprite_x
	dc.w	32,0			; 										; Put sprite this many pixels down from top of screen.				;   R_sprite_y
	dc.w	0,0				; 										; How many pixels will this sprite move automatically in x?			;   R_sprite_xadd
	...
	dc.l	0				;										; Width of collision box from centre in pixels						;   R_sprite_hbox
	dc.l	0				;										; Height of collision box from centre in pixels						;   R_sprite_vbox
	dc.l	SPRITE_1		;										; Place in memory where the sprite lives: label from RAPAPP.S		;   R_sprite_gfxbase
	dc.l	16				; 1,  2,  4,  8,  16,  24				; Sprite graphics type: 1,2,4,8,16 or 24 bit						;   R_sprite_bdepth
	dc.l	is_RGB			; is_RGB			is_cry				; Sprite graphics type. RGB or Atari's CRY format.					;   R_sprite_cryrgb
	dc.l	is_trans		; is_trans			is_opaque			; Trans for see-through background, opaque for solid background		;   R_sprite_trans
	dc.l	32*32*2			; 										; Size of sprite in bytes - used to find next frame of animation	;   R_sprite_framesz
...
;			value			possible values							description															label to access
	...
	dc.l	0				;										; Width of collision box from centre in pixels						;   R_sprite_hbox
	dc.l	0				;										; Height of collision box from centre in pixels						;   R_sprite_vbox
	dc.l	SPRITE_E		;										; Place in memory where the sprite lives: label from RAPAPP.S		;   R_sprite_gfxbase
	dc.l	16				; 1,  2,  4,  8,  16,  24				; Sprite graphics type: 1,2,4,8,16 or 24 bit						;   R_sprite_bdepth
	dc.l	is_RGB			; is_RGB			is_cry				; Sprite graphics type. RGB or Atari's CRY format.					;   R_sprite_cryrgb
	dc.l	is_trans		; is_trans			is_opaque			; Trans for see-through background, opaque for solid background		;   R_sprite_trans
	dc.l	32*32*2			; 										; Size of sprite in bytes - used to find next frame of animation	;   R_sprite_framesz
