...
;			value			possible values							description															label to access
	...
	dc.l	LOGO		;										; Place in memory where the sprite lives: label from RAPAPP.S		;   R_sprite_gfxbase
	dc.l	8				; 1,  2,  4,  8,  16,  24				; Sprite graphics type: 1,2,4,8,16 or 24 bit						;   R_sprite_bdepth
	...
	dc.l	320*200			; 										; Size of sprite in bytes - used to find next frame of animation	;   R_sprite_framesz
																	...
																	; *2 for 16bit
																	; *4 for 24bit
	dc.l	320			; 										; Width of a single row of sprite pixels							;   R_sprite_bytewid
	...
	dc.l	320			;										; Width of sprite within larger graphic.							;   R_sprite_gwidth
																	; Enter the x-size and add the following:
																	; /8 for 1bit
																	; /4 for 2bit
																	; /2 for 4bit
