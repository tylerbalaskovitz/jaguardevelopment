...
enum
{
	...
	R_sprite_cryrgb				=164,
	R_sprite_trans				=168,
	R_sprite_userdat1			=172,
	R_sprite_userdat2			=176,
	R_sprite_userdat3			=180,
	R_sprite_userdat4			=184,
	R_sprite_indexnumber		=188	// Sprite index number (Used by JagStudio higher level languages - also makes table 192 bytes for shift offsets)
};
...
RAPTOR_LIST *sprite=(RAPTOR_LIST*)((char*)&(RAPTOR_sprite_table));
extern RAPTOR_LIST *sprite asm("sprite");


typedef struct _RAPTOR_COLLISIONLIST
{
	int     objectHitAddr;
	int     objectSourceHitAddr;
}RAPTOR_COLLISIONLIST;
extern void *raptor_collisionlist asm ("raptor_collisionlist");
RAPTOR_COLLISIONLIST *colliders=(RAPTOR_COLLISIONLIST*)((char*)&(raptor_collisionlist));
extern RAPTOR_COLLISIONLIST *colliders asm("colliders");
...
enum
{
GD_ROMWRITE_ENABLE				=		0x1,
GD_ROMWRITE_DISABLE				=		0x0
};

// GD_FInfo & GD_DRead flags
enum
{
GD_FINFO_SHORT_NAME				=		0x0,
GD_FINFO_LONG_NAME				=		0x1
};
...
GD_FOPEN_READ					=		0x1,
GD_FOPEN_WRITE					=		0x2,
GD_FOPEN_OPEN_EXISTING			=		0x0,
GD_FOPEN_CREATE_NEW				=		0x4,
GD_FOPEN_CREATE_ALWAYS			=		0x8,
GD_FOPEN_OPEN_ALWAYS			=		0x10,
GD_FOPEN_OPEN_APPEND			=		0x30
};
...
enum
{
AM_RDO							=		0x1,	// Read only
AM_HID							=		0x2,	// Hidden
AM_SYS							=		0x4,	// System
AM_VOL							=		0x8,	// Volume Label
