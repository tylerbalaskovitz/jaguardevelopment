...
FUNCTION PrintWriteFormat$(DoWrite,nolinefeed)
  ...
  IF NewLineFlag = 0 THEN
    CONCAT (Frmat$,"\\r")
  END IF
  FUNCTION = "js_r_textbuffer=ee_printf(" + ENC$(Frmat$) + Clean$(Arg$) + ");"
  ...
  FOR Tmp = 1 TO Ndx
    ...
    SELECT CASE a
      ...
      SELECT CASE Keyword$
        ...
        CASE "rapsetactivelist"
		Stk$[Tmp]= "rapSetActiveList"
		...
		CASE "rapparticleinject"
		
		'Stk$[Tmp]= "rapParticleInject(int *)"+Stk$[Tmp+2]+");"
		Stk$[Tmp+1]= "((int *)"
		'Stk$[Tmp+2]= ""
...
SUB Emit
  ...
  SELECT CASE Lookup$
	...
	FPRINT Outfile,Scoot$,"jsfLoadClut(";
    ...
    CASE "vsync"
    '********************************************************************
    FPRINT Outfile,Scoot$,"jsfVsync(0);"
    ...
    FPRINT Outfile,Scoot$,"js_r_textbuffer=(char *)";lszTmp$;";"
    FPRINT Outfile,Scoot$,"rapPrint();"
    ...
    FPRINT Outfile,Scoot$,"js_r_textbuffer=(char *)";lszTmp$;";"
    FPRINT Outfile,Scoot$,"rapPrintCont();"
    ...
    FPRINT Outfile,Scoot$,"js_r_textbuffer=ee_printf("+DQ$+"%d"+DQ$+",";lszTmp$;");"
    FPRINT Outfile,Scoot$,"rapPrint();"
    ...
    FPRINT Outfile,Scoot$,"js_r_textbuffer=(char *)";lszTmp$;";"
    FPRINT Outfile,Scoot$,"rapDebugPrint();"
	
	'********************************************************************
    CASE "jsfdebugmessagehalt"
    '********************************************************************
    lszTmp$ = ""
    ...
    FPRINT Outfile,Scoot$,"js_r_textbuffer=(char *)";lszTmp$;";"
    FPRINT Outfile,Scoot$,"jsfDebugMessageHalt();"
	
	'********************************************************************
    CASE "jsfdebugmessage"
    '********************************************************************
    lszTmp$ = ""
    ...
    FPRINT Outfile,Scoot$,"js_r_textbuffer=(char *)";lszTmp$;";"
    FPRINT Outfile,Scoot$,"jsfDebugMessage();"
	
	'********************************************************************
    CASE "rapgddebugprint"
    '********************************************************************    
	
	FPRINT Outfile,Scoot$ ; PrintWriteFormat$(0,0)
    FPRINT Outfile,Scoot$ ; "rapGDDebugPrint();"
    ...
    FPRINT Outfile,Scoot$,"rapLocate(";lszTmp$;",";
    ...
    IF IsSprint THEN
      ZZ$ = "s" + PrintWriteFormat$(0,1)
      REMOVE "\\n" FROM ZZ$
    ELSE
      ZZ$ = "f" + PrintWriteFormat$(0,1)
    END IF
    ...
    CASE "print"
    '***********************
    FPRINT Outfile,Scoot$ ; PrintWriteFormat$(0,1)
    FPRINT Outfile,Scoot$ ; "rapPrint();"
    ...
    FPRINT Outfile,Scoot$,PrintWriteFormat$(1,1)
